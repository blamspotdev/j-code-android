...
J Code is licensed under the Business Source License 1.1 (see [`LICENSE`](LICENSE)),
which converts to the Apache License 2.0 on its Change Date. J Code bundles,
