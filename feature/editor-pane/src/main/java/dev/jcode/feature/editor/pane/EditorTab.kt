 ...
 * file-backed tab.
 */
enum class EditorPageKind { None, Settings, Environment, SdkDetail, LspDetail, DebugEngineDetail, ExtensionDetail, ExtensionPermissions, ExtensionApp, RunConfig, BuildConfig, Browser, ImageViewer, AndroidDevice, AppSandbox }
