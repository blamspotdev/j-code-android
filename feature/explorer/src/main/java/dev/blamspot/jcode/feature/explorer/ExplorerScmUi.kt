 ...
 * [dev.blamspot.jcode.fs.FsPath.stableId] (absolute host path).
 */
@Immutable
...
/** [dev.blamspot.jcode.fs.FsPath.stableId] of the open project's root folder, or null when unknown. The
