...
```kotlin
val jcodeVersion = "1.5.1"                                   // the train being prepared
...
train; merges do not move it. Previews of that train are built and published as `1.5.1-beta.N`, and
`1.5.1` is published from the same line of commits when it is ready — publishing it is what opens
the next train.

```
main = 1.5.1        merge, merge, merge          (jcodeVersion unchanged)
                    publish v1.5.1-beta.1        pre-release, dev.jcode.beta
                    merge
                    publish v1.5.1-beta.2        pre-release
                    publish v1.5.1               release, dev.jcode
...
|---|---|---|
| `1.5.1-alpha.1` | 1050001 | `N` |
| `1.5.1-beta.1` | 1050031 | `30 + N` |
| `1.5.1-beta.2` | 1050032 | |
| `1.5.1-rc.1` | 1050061 | `60 + N` |
| `1.5.1` | 1050099 | `99` |
| `1.5.1` | 1050199 | |

The old derivation ignored the suffix entirely, so `1.5.1-beta.1`, `1.5.1-beta.2` and `1.5.1` all
...
`1.5.1-beta.2 < 1.5.1-rc.1 < 1.5.1` — covered by `app/src/test/java/dev/jcode/UpdateCheckerTest.kt`.
...
|---|---|---|---|---|
| `beta`, label blank | `1.5.1-beta.N` (next) | `v1.5.1-beta.N` | `dev.jcode.beta` | pre-release |
| `stable` | `1.5.1` | `v1.5.1` | `dev.jcode` | release |
