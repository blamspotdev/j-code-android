...
object MonoFontCatalog {
    ...
    private val entries = listOf(
        Entry("jetbrains-mono", "JetBrains Mono", dev.blamspot.jcode.core.editor.R.font.jetbrains_mono_regular),
    )
    ...
    private fun withSystemFallback(context: Context, buildPrimary: () -> Font): Typeface? = runCatching {
        ...
        runCatching {
            val symbols = Font.Builder(context.resources, dev.blamspot.jcode.R.font.noto_sans_symbols2).build()
