...
import dev.blamspot.jcode.core.config.ProjectConfigs
import dev.blamspot.jcode.core.config.RunConfig
import dev.blamspot.jcode.core.config.RunConfigStore
import dev.blamspot.jcode.core.config.RunConfigTerminal
import dev.blamspot.jcode.feature.marketplace.RunConfigPreset
import dev.blamspot.jcode.feature.marketplace.RunPresetKind
...
object ProjectRunner {
     ...
     * encoding matches [dev.blamspot.jcode.design.WebPreviewBrowsers].
     */
        ...
        return runCatching {
            pm.queryIntentActivities(probe, android.content.pm.PackageManager.MATCH_ALL)
                .mapNotNull { ri ->
                    ...
                    dev.blamspot.jcode.design.BrowserApp(pkg, ri.loadLabel(pm).toString())
                }
