...
// overrides it to add the pre-release label a Beta build carries (e.g. 1.7.1-beta.1).
val jcodeVersion = "1.7.1"
 ...
 * suffix entirely, so 1.7.1-beta.1, 1.7.1-beta.2 and 1.7.1 all derived the *same* code — and
 ...
 *
 *     1.7.1-alpha.1  1060101      alpha.N -> N
 *     1.7.1-beta.1   1060131      beta.N  -> 30 + N
 *     1.7.1-beta.2   1060132
 *     1.7.1-rc.1     1060161      rc.N    -> 60 + N
 *     1.7.1          1060199      release -> 99   (always above every preview of itself)
 *
 ...
 * second app with an empty data directory. That is what happened at 1.7.1, when the app moved from
