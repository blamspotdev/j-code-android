 ...
 *
 *     1.7.0-alpha.1  1060101      alpha.N -> N
 *     1.7.0-beta.1   1060131      beta.N  -> 30 + N
 *     1.7.0-beta.2   1060132
 *     1.7.0-rc.1     1060161      rc.N    -> 60 + N
 *     1.7.0          1060199      release -> 99   (always above every preview of itself)
 *
 ...
 * second app with an empty data directory. That is what happened at 1.7.0, when the app moved from
