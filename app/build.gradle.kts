...
// overrides it to add the pre-release label a Beta build carries (e.g. 1.5.1-beta.1).
val jcodeVersion = "1.5.1"
 ...
 * suffix entirely, so 1.5.1-beta.1, 1.5.1-beta.2 and 1.5.1 all derived the *same* code — and
 ...
 *
 *     1.5.1-alpha.1  1050001      alpha.N -> N
 *     1.5.1-beta.1   1050031      beta.N  -> 30 + N
 *     1.5.1-beta.2   1050032
 *     1.5.1-rc.1     1050061      rc.N    -> 60 + N
 *     1.5.1          1050099      release -> 99   (always above every preview of itself)
 *
