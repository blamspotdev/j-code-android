...
// overrides it to add the pre-release label a Beta build carries (e.g. 1.6.2-beta.1).
val jcodeVersion = "1.6.2"
 ...
 * suffix entirely, so 1.6.2-beta.1, 1.6.2-beta.2 and 1.6.2 all derived the *same* code — and
 ...
 *
 *     1.6.2-alpha.1  1060101      alpha.N -> N
 *     1.6.2-beta.1   1060131      beta.N  -> 30 + N
 *     1.6.2-beta.2   1060132
 *     1.6.2-rc.1     1060161      rc.N    -> 60 + N
 *     1.6.2          1060199      release -> 99   (always above every preview of itself)
 *
